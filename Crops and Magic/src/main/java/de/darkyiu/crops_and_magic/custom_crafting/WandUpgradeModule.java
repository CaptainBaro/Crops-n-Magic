...
public enum WandUpgradeModule {
    ...
    NORMAL_COOLDOWN(ChatColor.GOLD + "Normal Cooldown", "Item.Upgrade.Normal_Cooldown", Material.GOLD_INGOT, 4, 10, 0, "This is the basic version of the cooldown reducing wand upgrade module.");
    ...
    WandUpgradeModule(String name, String id, Material material, int tier, double cooldown_reduction, double damage_increasing, String lore){
        this.name = name;
        this.id = id;
