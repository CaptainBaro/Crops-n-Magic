...
public class LaserSpell implements SpellAbility {
    ...
    public void onRightCLick(Player player, ItemStack itemStack) {
        BasicUtility.shootLaser(player,player.getEyeLocation(), 10, 2.5f, SpellListener.calculateDamage(player, 5, itemStack.getItemMeta().getLocalizedName()), Particle.VILLAGER_HAPPY, Sound.ENTITY_EXPERIENCE_ORB_PICKUP);
    }
}
